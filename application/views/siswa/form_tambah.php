...
<body>
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcrumb-content text-center">
                        <h2 class="page-title">Masukan Data Siswa</h2>
    ...
    <div class="card">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" id="inputPassword3" placeholder="Nama" name="input_nama" value="<?php echo set_value('input_nama'); ?>">
        </div>
      </div>
      <hr>
        ...
        <div class="row">
          ...
          <div class="col-sm-10">
            <div class="form-check">
              <input class="form-check-input" type="radio" name="input_jeniskelamin" value="Laki-Laki" <?php echo set_radio('jeniskelamin', 'Laki-Laki'); ?>>
              <label class="form-check-label" for="gridRadios1">
                Laki-Laki
              </label>
            </div>
            <div class="form-check">
            <input class="form-check-input" type="radio" name="input_jeniskelamin" value="Perempuan" <?php echo set_radio('jeniskelamin', 'Perempuan'); ?>>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" id="inputPassword3" placeholder="Kelas" name="input_kelas" value="<?php echo set_value('input_kelas'); ?>">
        </div>
      </div>
      <hr>
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" id="inputPassword3" placeholder="Jurusan" name="input_jurusan" value="<?php echo set_value('input_jurusan'); ?>">
        </div>
      </div>
